---
title: In 2024, Mastering Lock Screen Settings How to Enable and Disable on OnePlus 11R
date: 2024-12-23T16:21:49.704Z
updated: 2024-12-28T16:58:23.535Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Mastering Lock Screen Settings How to Enable and Disable on OnePlus 11R
excerpt: This article describes Mastering Lock Screen Settings How to Enable and Disable on OnePlus 11R
keywords: password unlock tool,OnePlus 11R how to use oem unlocking,smart lock android device,bypass lock screen password,android device password reset,reset gmail password on android,OnePlus 11R gusture lock screen,android emergency call bypass,forgot pattern lock
thumbnail: https://thmb.techidaily.com/dfd36bdece1f9de4c3b950ac0cec685d6ee5d1281721c2dd1a2340c4240b4f62.png
---

## Mastering Lock Screen Settings: How to Enable and Disable on OnePlus 11R
...
**Step 4:** After you set the phone to Download mode, it will begin to download the recovery package. When the recovery package is downloaded successfully, the lock screen on your OnePlus 11R devicewill be removed. You won't lose any data during the whole process.

![remove android lock screen](https://images.wondershare.com/drfone/guide/screen-unlock-any-android-device-6.png)

## How to Unlock OnePlus 11R Phone with Broken Screen

Seeing as the only way to control your OnePlus 11R deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the OnePlus 11R device. Here’s how to use this bridge.
...
**Step 4:** Connect the OnePlus 11R device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the OnePlus 11R device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the OnePlus 11R devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the OnePlus 11R device’s password lock.
