---
title: In 2024, Still Using Pattern Locks with Nokia C12 Pro? Tips, Tricks and Helpful Advice
date: 2024-05-19T09:20:15.404Z
updated: 2024-05-20T09:20:15.404Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Still Using Pattern Locks with Nokia C12 Pro? Tips, Tricks and Helpful Advice
excerpt: This article describes Still Using Pattern Locks with Nokia C12 Pro? Tips, Tricks and Helpful Advice
keywords: remove screen lock pin on android,unlock android device phone with broken screen,Nokia C12 Pro bypass android lock screen using emergency call,android pattern lock remover,Nokia C12 Pro hard pattern lock,easy pattern lock,unlock screen,Nokia C12 Pro disable lock screen,smart lock android
...
#### III.II: Forgot Your Pattern? Unlock Your Nokia C12 Pro Without Pattern Lock With Dr.Fone
...
The Best Tool to Unlock Your Nokia C12 Pro without Pattern Locks!
...
Note that this method wipes all data on the Nokia C12 Pro device. There is no way around it. You may be able to unlock select older Samsung devices without data loss. Check [this](https://drfone.wondershare.com/reference/android-lock-screen-removal.html) list for those devices.
...
As one of the initial measures, backup the Nokia C12 Pro device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Nokia C12 Pro device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Nokia C12 Pro device in bootloader mode. Disconnect the Nokia C12 Pro  device from the PC and turn the Nokia C12 Pro device off completely. Press the volume down button along with the power button to switch the Nokia C12 Pro device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Nokia C12 Pro device to select Fastboot option along with pressing power button to confirm, after the Nokia C12 Pro device is in bootloader mode. Now, connect the Nokia C12 Pro device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Nokia C12 Pro  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Nokia C12 Pro device in the command prompt. So, if the Nokia C12 Pro device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Nokia C12 Pro device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Nokia C12 Pro , one message will appear asking if you want to unlock the Nokia C12 Pro device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Nokia C12 Pro  device will restart once and it’s done. The device is now bootloader unlocked.
