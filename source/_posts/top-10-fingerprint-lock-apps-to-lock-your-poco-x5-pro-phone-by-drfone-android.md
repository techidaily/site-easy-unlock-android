...
date: 2024-04-30T16:14:56.848Z
updated: 2024-05-01T16:14:56.848Z
tags: 
  - unlock
  - remove screen lock
categories:
...
## Part 1: Common universal unlock pattern for Poco X5 Pro
...
## Part 2: \[Easiest\] Universal way to Unlock Pattern for Poco X5 Pro
...
There are a few things to keep in mind as you use this service to get around the lock screen. If the Android device is compatible, the Android Device Manager will connect it after a few tries. After it has been connected to the Poco X5 Pro device, we can begin by pressing the "Lock" button.
...
Type the new password once, then confirm it by typing it again. This will change the password in a few minutes and the new password can be used to unlock the Poco X5 Pro device.
...
As one of the initial measures, backup the Poco X5 Pro device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Poco X5 Pro device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Poco X5 Pro device in bootloader mode. Disconnect the Poco X5 Pro  device from the PC and turn the Poco X5 Pro device off completely. Press the volume down button along with the power button to switch the Poco X5 Pro device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Poco X5 Pro device to select Fastboot option along with pressing power button to confirm, after the Poco X5 Pro device is in bootloader mode. Now, connect the Poco X5 Pro device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Poco X5 Pro  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Poco X5 Pro device in the command prompt. So, if the Poco X5 Pro device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Poco X5 Pro device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Poco X5 Pro , one message will appear asking if you want to unlock the Poco X5 Pro device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Poco X5 Pro  device will restart once and it’s done. The device is now bootloader unlocked.
