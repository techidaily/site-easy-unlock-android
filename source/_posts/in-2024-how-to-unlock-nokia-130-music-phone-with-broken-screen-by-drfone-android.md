---
title: In 2024, How to Unlock Nokia 130 Music Phone with Broken Screen
date: 2024-08-02T11:33:56.401Z
updated: 2024-08-03T11:33:56.401Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Nokia 130 Music Phone with Broken Screen
excerpt: This article describes How to Unlock Nokia 130 Music Phone with Broken Screen
keywords: forgot pattern lock,Nokia 130 Music get into locked phone,Nokia 130 Music android device manager unlock,samfw frp tool,fingerprint lock app,how to remove previously synced google account from android,bypass android device lock screen using emergency call,Nokia 130 Music fingerprint lock for android,Nokia 130 Music how to change lock screen password,bypass knox enrollment service
thumbnail: https://thmb.techidaily.com/76a953455d282504d07d30484b3d441976cd7c068fdbe75a38577d96433ea41b.jpg
---

## How to Unlock Nokia 130 Music Phone with Broken Screen

Seeing as the only way to control your Nokia 130 Music deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Nokia 130 Music device. Here’s how to use this bridge.
...
**Step 4:** Connect the Nokia 130 Music device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
**Step 2:** As soon as the Nokia 130 Music devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Nokia 130 Music device’s password lock.
