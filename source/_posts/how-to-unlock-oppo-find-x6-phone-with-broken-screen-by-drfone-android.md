---
title: How to Unlock Oppo Find X6 Phone with Broken Screen
date: 2024-12-05T22:51:32.868Z
updated: 2024-12-07T17:07:46.679Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Oppo Find X6 Phone with Broken Screen
excerpt: This article describes How to Unlock Oppo Find X6 Phone with Broken Screen
keywords: disable lock screen,remove screen lock pin on android,how to reset voicemail password,locked out of android phone,vnrom bypass google account verification,Oppo Find X6 lock screen wallpaper on android,lock screen pattern
thumbnail: https://thmb.techidaily.com/650f46c8db195bf984ecb592d4a15814bfd7afa085c1775706e382ffb2952424.jpg
---

## How to Unlock Oppo Find X6 Phone with Broken Screen

Seeing as the only way to control your Oppo Find X6 deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Oppo Find X6 device. Here’s how to use this bridge.
...
**Step 4:** Connect the Oppo Find X6 device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Oppo Find X6 device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Oppo Find X6 devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Oppo Find X6 device’s password lock.
...
## How to Unlock Oppo Find X6 Pattern Lock if Forgotten? 6 Ways
...
- **Step 4.** You will be notified when the process is completed. Simply disconnect your Oppo Find X6 and access it without any pattern lock.
...
![select the Oppo Find X6 device](https://images.wondershare.com/drfone/article/2017/09/15057372918464.jpg)
...
- **Step 4.** Once the Oppo Find X6 device would be restarted in Safe Mode, the third-party lock screen would be disabled automatically.

![android safe mode](https://images.wondershare.com/drfone/article/2017/09/15057373753769.jpg)

- **Step 5.** Later, you can go to the Oppo Find X6 device’s Settings > Apps and remove the third-party app as well. In this way, you would be able to learn how to unlock pattern lock for any other app.
