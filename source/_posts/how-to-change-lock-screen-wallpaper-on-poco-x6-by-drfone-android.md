...
date: 2024-07-15T20:28:59.961Z
updated: 2024-07-16T20:28:59.961Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: Poco X6 locked out of android phone,Poco X6 pattern unlock,Poco X6 remove screen lock pin on android,Poco X6 top 10 frp bypass tools,Poco X6 password cracker tools,fingerprint lock for android device,unlock android device phone without password,reset locked android phone
...
## The Ultimate Guide to Poco X6 Pattern Lock Screen: Everything You Need to Know
...
<!-- affiliate ads end -->
## Part 1: How to set up Pattern Lock Screen on Poco X6?
...
As one of the initial measures, backup the Poco X6 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Poco X6 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Poco X6 device in bootloader mode. Disconnect the Poco X6  device from the PC and turn the Poco X6 device off completely. Press the volume down button along with the power button to switch the Poco X6 device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Poco X6 device to select Fastboot option along with pressing power button to confirm, after the Poco X6 device is in bootloader mode. Now, connect the Poco X6 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Poco X6  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Poco X6 device in the command prompt. So, if the Poco X6 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Poco X6 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Poco X6 , one message will appear asking if you want to unlock the Poco X6 device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Poco X6  device will restart once and it’s done. The device is now bootloader unlocked.
