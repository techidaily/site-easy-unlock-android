---
title: In 2024, How to Unlock Realme GT 3 Phone with Broken Screen
date: 2024-07-15T20:49:36.487Z
updated: 2024-07-16T20:49:36.487Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Realme GT 3 Phone with Broken Screen
excerpt: This article describes How to Unlock Realme GT 3 Phone with Broken Screen
keywords: android device pattern lock remover,lock screen wallpaper on android device,android device show wifi password,Realme GT 3 password cracker tools,remove lock screen fingerprint,Realme GT 3 android show wifi password,Realme GT 3 lock screen pattern,how to use oem unlocking,Realme GT 3 swipe screen to unlock
thumbnail: https://thmb.techidaily.com/5b0ce9c020094ad31bdc87530c31e032109184ed98794f1ba27d0b681ad3c785.jpg
---

## How to Unlock Realme GT 3 Phone with Broken Screen

Seeing as the only way to control your Realme GT 3 deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Realme GT 3 device. Here’s how to use this bridge.
...
**Step 4:** Connect the Realme GT 3 device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Realme GT 3 device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Realme GT 3 devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Realme GT 3 device’s password lock.
