---
title: How to Unlock Oppo K11x Phone with Broken Screen
date: 2024-06-24T04:40:15.934Z
updated: 2024-06-25T04:40:15.934Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Oppo K11x Phone with Broken Screen
excerpt: This article describes How to Unlock Oppo K11x Phone with Broken Screen
keywords: Oppo K11x hard pattern lock,Oppo K11x unlock bootloader,bypass android lock screen using emergency call,reset locked android device phone,swipe screen to unlock,unlock phone forgot password,how to unlock android device phone without google account,universal unlock pattern for android,Oppo K11x rootjunky frp bypass,Oppo K11x delete gmail account with without password,lock screen pattern,Oppo K11x unlock phone guide
thumbnail: https://thmb.techidaily.com/92d4d3774b8fd498c6cfb488cbb5cb9a7cceb0aea3bc2d6cdbbe36e4703b4b56.jpg
---

## How to Unlock Oppo K11x Phone with Broken Screen

Seeing as the only way to control your Oppo K11x deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Oppo K11x device. Here’s how to use this bridge.
...
**Step 4:** Connect the Oppo K11x device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Oppo K11x device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Oppo K11x devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Oppo K11x device’s password lock.
...
## How to Unlock Oppo K11x Phone without Any Data Loss
...
## Part 1. How to Unlock Oppo K11x Phone with Dr.Fone - Screen Unlock (Android)
...
**Step 6.** ADB terminal will pop out. Now, the first is to type in ADB _devices_. This is to check if your device is recognized by ADB. If there is no device listed below, try to remove and reconnect your Oppo K11x and retype the command. If there are listed devices already, proceed.
