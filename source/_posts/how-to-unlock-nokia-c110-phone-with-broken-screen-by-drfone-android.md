---
title: How to Unlock Nokia C110 Phone with Broken Screen
date: 2024-09-07T00:52:56.300Z
updated: 2024-09-08T00:52:56.300Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Nokia C110 Phone with Broken Screen
excerpt: This article describes How to Unlock Nokia C110 Phone with Broken Screen
keywords: Nokia C110 lock screen wallpaper on android,bypass android lock screen using emergency call,Nokia C110 android lock screen settings,Nokia C110 locked out of android phone,how to unlock android device phone without google account,Nokia C110 find lost phone with google map,Nokia C110 delete gmail account with without password,android screen lock
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Nokia C110 device. Here’s how to use this bridge.
...
**Step 4:** Connect the Nokia C110 device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Nokia C110 device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
<!-- affiliate ads end -->
**Step 2:** As soon as the Nokia C110 devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Nokia C110 device’s password lock.
...
## How To Fix OEM Unlock Missing on Nokia C110?
...
- **Step 2:** Specify the Nokia C110 device type for screen lock removal.
