...
date: 2024-07-15T20:29:31.624Z
updated: 2024-07-16T20:29:31.624Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Poco X6 Phone with Broken Screen
excerpt: This article describes How to Unlock Poco X6 Phone with Broken Screen
keywords: hack wifi password android,Poco X6 gusture lock screen,unlock android phone without password,android device device manager unlock,remove forgotten pin android,android lock screen settings,bypass lock screen password
thumbnail: https://thmb.techidaily.com/4824b5bc1ec47ceadb929bb6b68e8c9454196f2de65b71eab7da2ab3371e3a0f.png
---

## How to Unlock Poco X6 Phone with Broken Screen

Seeing as the only way to control your Poco X6 deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Poco X6 device. Here’s how to use this bridge.
...
**Step 4:** Connect the Poco X6 device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
**Step 2:** As soon as the Poco X6 devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Poco X6 device’s password lock.
