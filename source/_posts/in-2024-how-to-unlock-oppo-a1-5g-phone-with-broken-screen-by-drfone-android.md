---
title: In 2024, How to Unlock Oppo A1 5G Phone with Broken Screen
date: 2025-01-12T21:53:42.959Z
updated: 2025-01-19T16:49:57.215Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Oppo A1 5G Phone with Broken Screen
excerpt: This article describes How to Unlock Oppo A1 5G Phone with Broken Screen
keywords: techeligible frp bypass,lock screen pattern,best sim location trackers,Oppo A1 5G unlock screen,unlock with google assistant,Oppo A1 5G android device manager unlock,how to change lock screen password,Oppo A1 5G bypass android face lock,Oppo A1 5G unlock bootloader,lock screen wallpaper on android device
thumbnail: https://thmb.techidaily.com/5323ab269b6d5447358ffbce683d20a8b0db809b59cc59254c5cb25869dff46a.jpg
---

## How to Unlock Oppo A1 5G Phone with Broken Screen

Seeing as the only way to control your Oppo A1 5G deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Oppo A1 5G device. Here’s how to use this bridge.
...
**Step 4:** Connect the Oppo A1 5G device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Oppo A1 5G device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Oppo A1 5G devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Oppo A1 5G device’s password lock.
...
## Remove the Lock Screen Fingerprint Of Your Oppo A1 5G
...
If your fingerprint is not working or the Oppo A1 5G device prompts you with an error in the fingerprint functioning, possibly the fingerprint reader is not responding, and the Oppo A1 5G device needs to restart to get rid of this error.

![phone restart ui](https://images.wondershare.com/drfone/article/2022/11/how-to-bypass-android-fingerprint-lock-3.jpg)

When a device restarts, the fingerprint functionality is restored after entering the Oppo A1 5G device pattern, password, or PIN. This is the simplest method to reset your fingerprint hardware.
...
4. Once more, select "Erase." This will reset the Oppo A1 5G device and get rid of the dysfunctional fingerprint lock.
