...
date: 2024-07-15T20:26:26.692Z
updated: 2024-07-16T20:26:26.692Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Poco X6 Pro Phone with Broken Screen
excerpt: This article describes How to Unlock Poco X6 Pro Phone with Broken Screen
keywords: Poco X6 Pro change android lock screen,android lock screen settings,Poco X6 Pro unlock phone forgot password,easy pattern lock,Poco X6 Pro bypass knox enrollment service,techeligible frp bypass
thumbnail: https://thmb.techidaily.com/7ad836b78743150f7926162559e15271095acf4f64d610e7943b29ad8777b2c6.jpg
---

## How to Unlock Poco X6 Pro Phone with Broken Screen

Seeing as the only way to control your Poco X6 Pro deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Poco X6 Pro device. Here’s how to use this bridge.
...
**Step 4:** Connect the Poco X6 Pro device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
**Step 2:** As soon as the Poco X6 Pro devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Poco X6 Pro device’s password lock.
...
Since you have already paired Bluetooth, it will ask you to choose the Poco X6 Pro device from the list.
...
The device begins to gather data about your face. The trusted face icon appears. As a backup, in case Smart Lock does not recognize your face, use the manual system by applying the PIN or password to unlock the Poco X6 Pro device.
