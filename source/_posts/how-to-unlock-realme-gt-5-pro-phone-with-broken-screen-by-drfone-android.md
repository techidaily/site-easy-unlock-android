---
title: How to Unlock Realme GT 5 Pro Phone with Broken Screen
date: 2024-06-08T13:27:46.078Z
updated: 2024-06-09T13:27:46.078Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Realme GT 5 Pro Phone with Broken Screen
excerpt: This article describes How to Unlock Realme GT 5 Pro Phone with Broken Screen
keywords: oem unlock missing,Realme GT 5 Pro unlock phone guide,Realme GT 5 Pro delete gmail account with without password,Realme GT 5 Pro turn off google smart lock,unlock android device phone pattern lock without factory reset,Realme GT 5 Pro android password reset,remove screen lock pin on android device,Realme GT 5 Pro fingerprint lock for android,bypass android lock screen using emergency call,password unlock tool
thumbnail: https://thmb.techidaily.com/675815b145dcafd84fe359ee4ac52511e6c57ba8907f6c40cdafb2c11a8f5a83.jpg
---

## How to Unlock Realme GT 5 Pro Phone with Broken Screen

Seeing as the only way to control your Realme GT 5 Pro deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Realme GT 5 Pro device. Here’s how to use this bridge.
...
**Step 4:** Connect the Realme GT 5 Pro device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Realme GT 5 Pro device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Realme GT 5 Pro devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Realme GT 5 Pro device’s password lock.
