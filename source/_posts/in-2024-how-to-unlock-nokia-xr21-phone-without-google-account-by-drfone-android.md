---
title: In 2024, How to Unlock Nokia XR21 Phone without Google Account?
date: 2024-08-02T11:32:05.122Z
updated: 2024-08-03T11:32:05.122Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Nokia XR21 Phone without Google Account?
excerpt: This article describes How to Unlock Nokia XR21 Phone without Google Account?
keywords: Nokia XR21 change android lock screen,Nokia XR21 unlock,turn off google smart lock,Nokia XR21 lock apps with fingerprint,android device screen lock,how to remove previously synced google account from android,Nokia XR21 fingerprint lock for android,Nokia XR21 easy pattern lock,Nokia XR21 unlock android phone without password,reset locked android phone,Nokia XR21 unlock with google assistant,remove screen lock pin on android
thumbnail: https://thmb.techidaily.com/73182ed54b3d34ca981abeae24ed800ccc098d1b157cf1a2528e89d05cbc2979.jpg
---

## How to Unlock Nokia XR21 Phone without Google Account?
...
3\. A list of all of the Nokia XR21 devices registered to this Android account will pop up. Select the Nokia XR21 device in question from this list.
...
Now connect your Android phone connected with the PC, and select the Nokia XR21 device brand from the list.
...
As one of the initial measures, backup the Nokia XR21 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Nokia XR21 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Nokia XR21 device in bootloader mode. Disconnect the Nokia XR21  device from the PC and turn the Nokia XR21 device off completely. Press the volume down button along with the power button to switch the Nokia XR21 device on in bootloader mode.
...
Step 5: Use the volume keys of the Nokia XR21 device to select Fastboot option along with pressing power button to confirm, after the Nokia XR21 device is in bootloader mode. Now, connect the Nokia XR21 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Nokia XR21  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Nokia XR21 device in the command prompt. So, if the Nokia XR21 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Nokia XR21 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Nokia XR21 , one message will appear asking if you want to unlock the Nokia XR21 device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Nokia XR21  device will restart once and it’s done. The device is now bootloader unlocked.
...
<!-- affiliate ads end -->
## Top 4 SIM Location Trackers To Easily Find Your Lost Nokia XR21 Device
...
- Set up virtual boundaries and receive alerts when the Nokia XR21 device enters or leaves these areas.
...
- Set up virtual boundaries and get alerts if the Nokia XR21 device enters or exits these areas.
...
- **Step 5:** The screen will invite you to perform several actions, starting with removing the SIM card from the iDevice. To access the Nokia XR21 device's network settings, go to **Settings,** then **WLAN**. Find the Wi-Fi networks you've joined and select **Forget This Network**.
